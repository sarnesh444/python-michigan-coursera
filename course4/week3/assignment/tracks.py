...
#-----if does not exist then creates one-----#
conn = sqlite3.connect('trackdb.sqlite')

#------cursor is like a pointer to a row,or like a file handler------#
cur = conn.cursor()
...
if ( len(fname) < 1 ) : fname = r'C:\Users\saran\Desktop\python_michighan\course4\week3\assignment\Library.xml'
